            ...
            try {
                ...
                switch (choix) {
                    ...
                    case 4:
                        ...
                        Programmeur programmeur = new Programmeur(nomP, prenomP, naissanceP, adresseP, pseudoP, responsableP, hobbyP, salaireP, primeP) ;
                        actionsBDD.addProgrammeur(programmeur);
                        break;
                    case 5:
                        System.out.println("Pour quelle programmeur souhaitez vous modifié le salaire (fournir l'id)\n");
